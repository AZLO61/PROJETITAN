...
export const LEXIQUE = [
  ...
  { icon: ICON("adrenaline"), nom: "Adrénaline", def: "Permet de modifier la valeur d'énergie d'une action. Tu en gagnes 1 à chaque début de Manche — et 1 par carte défaussée si l'option de table « Adrénaline à la défausse » est cochée (Nikola, 24 septembre 2026). Elle se conserve d'une Manche à l'autre, et la réserve encore en main à la fin de la partie rapporte des points selon un barème progressif : 1 · 3 · 5 · 8 · 12 · 17 · 22 · 28 points pour 1 à 8 Adrénalines. Une petite réserve ne vaut presque rien, une grosse réserve vaut cher — garder deux jetons par négligence ne paie pas, thésauriser sur toute la partie paie." },
  ...
  { icon: ICON("projection"), nom: "Projection", def: "Un TITAN qui arrive sur une case occupée pousse ce qui s'y trouve — un autre Titan, un débris isolé, un tas entier — d'un nombre de cases égal à l'énergie restante, et toujours d'au moins 1 case même s'il arrive en bout de course. Il n'y a AUCUNE condition d'énergie pour bousculer : le Titan qu'une attaque a mis en mouvement ne monte jamais sur ce qu'il percute (Nikola, 7 septembre 2026). Un DÉBRIS en vol, lui, ne pousse pas ce qu'il croise : il s'empile dessus et forme un Amas — le béton s'empile, le Titan bouscule. La chaîne de poussée peut se poursuivre de proche en proche, et chaque Titan DISTINCT TOUCHÉ rapporte 1 Bagarre à l'initiateur, qu'il ait été déplacé ou non — mais un Titan déjà en mouvement dans la réaction n'est jamais poussé une seconde fois." },
...
export const CARTES = [
  ...
  },
  {
    ...
    note: "🚫💉 Aucune Adrénaline ne se dépense sur Graouhhh : le recul ne se modifie ni en + ni en −. 🎁 Bonus : +1 Adrénaline par Titan touché au-delà du premier (2 touchés → +1, 3 touchés → +2).",
  },
  {
    num: "04",
    nom: "Boing Boing",
