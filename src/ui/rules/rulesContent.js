...
export const BADGES = [
  { code: "DIL", nom: "Dilemme", def: "L'attaquant désigne 2 options différentes chez la cible : une couleur de son Repaire, « un Socle tiré au sort » si elle en possède au moins un, ou « 1 Adrénaline » si elle en a au moins une. La cible choisit laquelle des 2 elle perd, ou paie 1 Adrénaline pour annuler. L'option Socle est anonyme : personne ne choisit lequel partira ni ne connaît sa valeur avant le tirage. Le VERT ne peut jamais être désigné, sauf s'il est la seule couleur du Repaire : sa valeur n'existe qu'au décompte final, en fixer la perte reviendrait à jouer un prix que personne ne connaît. Impossible s'il n'y a pas 2 options distinctes — mais « 1 couleur + 1 Socle » suffit, et « 1 couleur + 1 Adrénaline » aussi (Nikola, 3 septembre 2026 : plus personne n'est immunisé pour avoir tout misé sur une seule couleur). Une Adrénaline perdue passe TOUJOURS chez l'attaquant : elle ne tombe jamais au sol. Où va l'élément perdu dépend de la CARTE jouée, voir le tableau ci-dessous.", color: "#FFD93D" },
