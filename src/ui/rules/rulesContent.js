...
export const LEXIQUE = [
  ...
  { icon: ICON("adrenaline"), nom: "Adrénaline", def: "Permet de modifier la valeur d'énergie d'une action. Tu en gagnes 1 à chaque début de Manche. Elle se conserve d'une Manche à l'autre, et la réserve encore en main à la fin de la partie rapporte des points selon un barème progressif : 1 · 3 · 5 · 8 · 12 · 17 · 22 · 28 points pour 1 à 8 Adrénalines. Une petite réserve ne vaut presque rien, une grosse réserve vaut cher — garder deux jetons par négligence ne paie pas, thésauriser sur toute la partie paie." },
